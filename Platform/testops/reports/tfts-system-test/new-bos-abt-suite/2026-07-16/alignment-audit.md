...
- Cases audited: **397**
- Blocking findings: **0**
- Advisory (reviewed-intentional) findings: **398**

## Residual mojibake in any field - 0
_none_

## Title missing the ' - ' feature separator _(advisory)_ - 374
- C4103159 | Smartrack access rights for administrator and user
- C4103160 | View and search card data
- C4103161 | Add notes and attached files to a card
- C4103162 | View card transactions
- C4103163 | Import a card issue and pass-create record file
- C4103164 | Export the ESN list
- C4103165 | Run the Action List reports
- C4103166 | Run the Liability and Scheme Liability reports
- C4103167 | Run the Default Payment report
- C4103168 | Run the Delivery report
- C4103169 | Run the Refund report
- C4103170 | Run the Decommission Card report
- C4103171 | Run the POS Revenue Analysis report
- C4103143 | View the available reports in the Merit Web Reporter
- C4103144 | View and export a report in the Merit Web Reporter
- C4103094 | Timeband Editor
- C4103095 | Staff Editor
- C4103096 | Class Type and Class Group Editors
- C4103097 | Location, Location Group and Location Restrictions Editors
- C4103098 | Route Group Editor
- C4103099 | Route Revenue Editor
- C4103100 | Sales Breakdown reports
- C4103101 | Sales Analysis by Class report
- C4103102 | Origin and Destination reports
- C4103103 | Bus Loading by Route/Journey report
- C4103104 | Route/Stage reports
- C4103105 | Journey Analysis reports
- C4103106 | Stage Timeband report
- C4103107 | Patronage Timeband report
- C4103108 | Revenue and Revenue by Stop reports
- C4103109 | Class Breakdown and Route Breakdown reports
- C4103110 | POS Revenue report
- C4103111 | Duty Comparison and Driver Shift reports
- C4103112 | Bus Serviceability Final Defects report
- C4103113 | GPS reports
- C4103114 | Route Purchase report
- C4103115 | Pay-In Reconciliation report
- C4103116 | Translink Class Revenue Performance report
- C4103117 | Translink Route Revenue Performance report
- C4103118 | Translink Period Trend Analysis reports
- C4103119 | Tickets By Operator report
- C4103120 | NIR Revenue Performance reports
- C4103121 | NIR Period Trend Analysis reports
- C4103122 | BRT Revenue Performance reports
- C4103123 | Glider Revenue Performance reports
- C4103124 | Ticketing Reports including timebands
- C4103125 | Revenue Foregone reports
- C4103126 | Concessionary Class Summary reports
- C4103127 | ENTCS Passenger and Revenue reports
- C4103128 | Fare Foregone reports
- C4103129 | Daily Summary report
- C4103130 | Daily Audit reports
- C4103131 | Class Audit and Route Audit reports
- C4103132 | Annulled Tickets report
- C4103133 | Inspectors report
- C4103134 | Outstanding Duties report
- C4103135 | Stage List report
- C4103136 | Origin and Destination Distance reports
- C4103137 | Route Distance Analysis report
- C4103138 | Ulsterbus revenue stored procedures
- C4103139 | Metro revenue stored procedures
- C4103140 | NIR rail revenue stored procedures
- C4103141 | Synchronise staff into Merit
- C4103142 | Browse audit data with Client Tools
- C4102960 | Sign on with username and password
- C4102961 | Sign on with a Google account
- C4102962 | Sign off
- C4102963 | Configure report access for a role
- C4102964 | Configure module and group access for a role
- C4102965 | Navigate the Settings menu
...
- C4102976 | Navigate the Topology & Fares Management menu
- C4102977 | Filter topology by operator
- C4102978 | Export fares
- C4102979 | Import a map point file (CSV)
- C4102980 | Import route data at parent and child level
- C4102981 | Add a new map point
- C4102982 | Create, edit and delete a zone
- C4102983 | Configure positional points on a route
- C4102984 | Export and edit map points via file
- C4102985 | Search for a map point
- C4102986 | Create, amend, copy and delete a route
- C4102987 | Configure a route's service code and operator
- C4102988 | Enable ABT flat fare on a route
- C4102989 | Enable transfers and set the transfer time on a route
- C4102990 | Configure a route's fares triangle and calculate a fare
- C4102991 | Configure an ETM rail substitute route
- C4102992 | Configure a product
- C4102993 | Configure an ABT product
- C4102994 | Configure an Open product
- C4102995 | Configure a FLU product
- C4102996 | Configure a Preset Reverse FLU product
- C4102997 | Configure a Reference Type product
- C4102998 | Configure an Excess product
- C4102999 | Configure a Smartcard product
- C4103000 | Configure a Barcode product
- C4103001 | Configure the alighting stage for a product
- C4103002 | Configure annulments per device for a product
- C4103003 | Configure the passback period for a product
- C4103004 | Configure device keyboard buttons for products
- C4103005 | Create and edit a FLU product group
- C4103006 | Set a product assignment expiry
- C4103007 | Add a fares rule
- C4103008 | Configure an e-Purse single fares charge rule
- C4103009 | Configure a fixed fare rule
- C4103010 | Card Reference File validates alighting stages across devices
- C4103011 | Label configuration data
- C4103012 | Publish configuration with a future transition date
- C4103013 | Publish an old configuration
- C4103014 | Delete a topology label
- C4103031 | Filter the activity log by activity, device, date and time
- C4103032 | Page through the activity log
- C4103033 | View transactions, events and staff activity
- C4103034 | Filter the activity log by barcode ID
- C4103035 | Failed validations and payments appear in the activity log
- C4103036 | View and edit device information
- C4103037 | Disable and enable a device
- C4103041 | Create and modify a device dataset version
- C4103042 | Upload and configure device software
- C4103043 | Manage device dataset version state and deployment
- C4103044 | Add, modify and disable a staff member
- C4103045 | Modify a staff member's PIN
- C4103046 | Modify a staff member's home and working location
- C4103047 | View staff history
...
- C4103055 | View the Dashboard summary tiles
- C4103056 | Create, clone, favourite and delete a dashboard
- C4103057 | Add and remove dashboard tiles
- C4103058 | View a dashboard full screen
- C4103059 | Create, view, edit and delete an alert configuration
- C4103061 | Configure event groups
- C4103063 | Run the Depot Location Report
- C4103064 | Run the Devices Last Seen Report
- C4103065 | Run the Software Versions Report
- C4103066 | Run the Staff Activity Report
- C4103067 | Run the Engineer Visits Report
- C4103068 | Run the Revenue Inspector's Report
- C4103069 | Run the TVM cash collection reports
- C4103070 | Run the TVM cash revenue reports
- C4103071 | Run the Rules List Export
- C4103072 | Run the Concise Area & Reference Fare Report
- C4103073 | Run the Route List Export
- C4103074 | Run the Product to Ticket Assignment Report
- C4103075 | Run the Product List Report
- C4103076 | Run the Events & Alerts Report
- C4103077 | Run the Vehicle Check Report
- C4103078 | Run the CloudFare Usage Report
- C4103079 | Run the Reports end-to-end flow
- C4103080 | Create, edit and copy a ticket layout
- C4103081 | Add ticket elements to a template
- C4103082 | Configure a ticket for different devices
- C4103083 | Configure a change ticket
- C4103084 | Configure a product on a ticket
- C4103085 | Group a set of ticket layouts
- C4103086 | Add a barcode to a ticket
- C4103087 | Configure payment-card fields on a ticket
- C4103088 | Create a rail line and station
- C4103089 | Delete or change a station
- C4103090 | Add a branch
...
- C4103485 | Taps held on a blocked ETM are processed and capped when the device is unblocked - 80 chars
- C4103476 | Metro and Ulsterbus caps evaluate independently when taps are interleaved - 73 chars
- C4103484 | Boundary — the third yearly correction is accepted and an immediate fourth is refused - 85 chars
...
- C4103591 | Taps either side of the 04:00 operating-day boundary fall into different cap days - 81 chars
- C4103595 | A Sunday-start CSV bitmask is stored and filtered as the Monday-start DB order - 78 chars
