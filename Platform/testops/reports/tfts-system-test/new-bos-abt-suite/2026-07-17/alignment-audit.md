...
- Cases audited: **391**
- Blocking findings: **282**
- Advisory (reviewed-intentional) findings: **232**
...
- C4102980 | [UNCONFIRMED] Import route data at parent and child operator level
...
## Title over 72 chars _(advisory)_ - 108
- C4102989 | [UNCONFIRMED] Route — enable Multi-Journey transfers and set the transfer time - 78 chars
- C4102999 | Product — a Smartcard product is configured (WTS SmartCreate / SmartRecharge) - 77 chars
- C4103004 | [UNCONFIRMED] Product buttons — assigned via Menu product groups per device - 75 chars
- C4103035 | Activity Log — failed validations, declined taps and failed payments are identified with reason - 95 chars
- C4102758 | [UNCONFIRMED] Metro cap — correction outside the Metro zone removes the cap and charges the difference - 102 chars
- C4102759 | [UNCONFIRMED] Metro cap — correction into the Metro zone applies the cap and refunds the difference - 99 chars
- C4102760 | [UNCONFIRMED] Metro cap — correcting a settled free (capped) tap keeps it at £0.00 - 82 chars
- C4102761 | [UNCONFIRMED] Metro cap — correcting a settled partially-capped tap keeps it at £1.70 - 85 chars
- C4102764 | [UNCONFIRMED] Metro cap — correcting the first full-fare tap leaves its charge unchanged - 88 chars
- C4102765 | [UNCONFIRMED] Metro cap — correcting an unsettled capped tap re-evaluates and stays free - 88 chars
- C4102766 | [UNCONFIRMED] Metro cap — a declined journey is not treated as a settled capped tap - 83 chars
- C4102767 | [UNCONFIRMED] Metro cap — re-running settlement after a correction does not re-charge the capped tap - 100 chars
- C4102768 | [UNCONFIRMED] Zonal cap — higher-fare correction within the zone holds the cap - 78 chars
- C4102769 | [UNCONFIRMED] Zonal cap — higher-fare correction outside the zone removes the cap and charges the difference - 108 chars
- C4102770 | [UNCONFIRMED] Zonal cap — lower-fare correction within the zone, day still above cap, holds - 91 chars
- C4102771 | [UNCONFIRMED] Zonal cap — lower-fare correction drops the day below cap and refunds - 83 chars
- C4102772 | [UNCONFIRMED] Zonal cap — Zone 4 correction within the highest band holds the cap - 81 chars
- C4102773 | [UNCONFIRMED] Zonal cap — correction into a capped zone audits a free tap under the zonal cap - 93 chars
- C4102774 | [UNCONFIRMED] Zonal cap — a correction into a capped zone does not increase the account total - 93 chars
- C4102775 | [UNCONFIRMED] Zonal cap — a corrected tap reports under the zonal cap, not a reference cap - 90 chars
- C4102776 | [UNCONFIRMED] Zonal cap — correcting into a zone below cap charges toward the zonal cap - 87 chars
- C4102777 | [UNCONFIRMED] Reference cap — a journey with no zonal cap still uses the reference cap - 86 chars
- C4102778 | [UNCONFIRMED] Zonal cap — correcting to another stop in the same zone keeps the cap - 83 chars
- C4102779 | [UNCONFIRMED] Zonal cap — re-running settlement after a correction adds no charge - 81 chars
- C4102780 | [UNCONFIRMED] Zonal cap — the cap applies after a correction regardless of transport mode - 89 chars
- C4102781 | [UNCONFIRMED] Reference cap — correction to a higher ref removes the cap and charges the difference - 99 chars
- C4102782 | [UNCONFIRMED] Reference cap — correction to a lower ref below the cap removes it and refunds - 92 chars
- C4102783 | [UNCONFIRMED] Reference cap — correction to a lower ref still above the cap charges the extra - 93 chars
- C4102784 | [UNCONFIRMED] Uncapped tap — single tap raised to a higher fare charges the difference - 86 chars
- C4102786 | [UNCONFIRMED] Reference cap — aligning two different-ref taps to the same ref applies the cap and refunds - 105 chars
- C4102787 | [UNCONFIRMED] Reference cap — lowering the higher-ref tap to match applies the lower cap and refunds - 100 chars
- C4102788 | [UNCONFIRMED] Town service cap — correction within the town zone holds the cap - 78 chars
- C4102789 | [UNCONFIRMED] Town service cap — correction outside the town to a higher fare removes the cap and charges the difference - 120 chars
- C4102790 | [UNCONFIRMED] Town service cap — correction outside the town to a lower fare removes the cap and refunds - 104 chars
...
- C4102816 | [UNCONFIRMED] Duplicate Detection — a repeated same-stage tap is not charged again - 82 chars
- C4102817 | [UNCONFIRMED] Duplicate Detection — an out-of-order (earlier-timestamp) repeat tap is still a duplicate - 103 chars
- C4102818 | [UNCONFIRMED] Duplicate Detection — interleaved retail transactions do not reset the duplicate reference - 104 chars
- C4102819 | [UNCONFIRMED] Duplicate Detection — a same-stage repeat tap after a different-stage retail is still a duplicate - 111 chars
...
- C4102823 | [UNCONFIRMED] Journey History — an annulled (cancelled) journey remains visible - 79 chars
- C4102827 | [UNCONFIRMED] Journey History — correcting a non-cancelled journey keeps it active at its new fare (CR122) - 106 chars
- C4102833 | [UNCONFIRMED] Journey History — a settled TOO journey offers onward stops for correction (CR122) - 96 chars
- C4102834 | [UNCONFIRMED] Journey History — a settled TOO journey from another stage offers onward stops (CR122) - 100 chars
- C4102835 | [UNCONFIRMED] Journey History — two settled ref.60 taps from the same stage each offer onward stops (CR122) - 107 chars
- C4102836 | [UNCONFIRMED] Journey History — re-opening the correction always offers the onward stops (CR122) - 96 chars
- C4102837 | [UNCONFIRMED] Journey History — no onward stops offered when boarding is the last stop on the route (CR122) - 107 chars
- C4102838 | [UNCONFIRMED] Journey History — correction offers stops for the journey's operator (CR122) - 90 chars
- C4102839 | [UNCONFIRMED] Alighting-Stop Correction — fare-based filter of offered stops (CR122) - 84 chars
- C4102840 | [UNCONFIRMED] Alighting-Stop Correction — zero-fare transfer stops excluded (CR122) - 83 chars
- C4102841 | [UNCONFIRMED] Alighting-Stop Correction — positive-fare stops offered (CR122) - 77 chars
- C4102842 | [UNCONFIRMED] Alighting-Stop Correction — selecting a stop updates the alighting stage and recalculates the fare (CR122) - 120 chars
- C4102843 | [UNCONFIRMED] Alighting-Stop Correction — zero-fare stop hidden while smallest positive-fare stop shown (CR122) - 111 chars
- C4102844 | [UNCONFIRMED] Journey History — a £0.00 capped journey stays visible and correctable (CR122) - 92 chars
- C4102846 | [UNCONFIRMED] Journey History — a transfer journey charged £0.00 stays displayed and correctable (CR122) - 104 chars
- C4102847 | [UNCONFIRMED] Alighting-Stop Correction — negative-fare stop excluded (CR122) - 77 chars
- C4102848 | [UNCONFIRMED] Alighting-Stop Correction — positive-fare transfer stops still offered (CR122) - 92 chars
- C4102849 | [UNCONFIRMED] Alighting-Stop Correction — TVM-only positive-fare stops still offered (CR122) - 92 chars
...
- C4102953 | [UNCONFIRMED] Zones — a multi-zone stop is a member of each of its travel zones - 79 chars
- C4102954 | [UNCONFIRMED] Declined taps — each decline reason is recorded on the Declined Taps Report - 89 chars
...
- C4103480 | [UNCONFIRMED] Correction Limits — first alighting-stop correction in the month is accepted (CR122) - 98 chars
- C4103481 | [UNCONFIRMED] Correction Limits — a second correction in the same month is refused (CR122) - 90 chars
- C4103482 | [UNCONFIRMED] Correction Limits — a correction in a new month is accepted within the annual limit (CR122) - 105 chars
- C4103483 | [UNCONFIRMED] Correction Limits — a fourth correction in the year is refused (CR122) - 84 chars
- C4103484 | [UNCONFIRMED] Correction Limits — third yearly correction accepted, immediate fourth refused (CR122) - 100 chars
...
- C4102824 | [UNCONFIRMED] Journey History — an annulled £0.00 journey is still visible - 74 chars
- C4102825 | [UNCONFIRMED] Journey History — correcting the alighting stop on a cancelled tap keeps it visible (CR122) - 105 chars
- C4102826 | [UNCONFIRMED] Journey History — a zero-fare correction on a cancelled tap leaves one visible row (CR122) - 104 chars
- C4102828 | [UNCONFIRMED] Journey History — a cancelled journey stays cancelled after a stop correction and further settlement (CR122) - 122 chars
- C4102829 | [UNCONFIRMED] Journey History — annulling one journey does not affect other journeys - 84 chars
- C4102830 | [UNCONFIRMED] Journey History — cancelling a charged journey refunds it and retains the record - 94 chars
- C4102831 | [UNCONFIRMED] Journey History — correcting the stop on a refunded cancelled tap keeps one record and raises no further refund (CR122) - 133 chars
- C4102832 | [UNCONFIRMED] Journey History — a cancelled transfer journey remains visible - 76 chars
- C4102845 | [UNCONFIRMED] Journey History — a cancelled £0.00 journey stays visible and correctable (CR122) - 95 chars
...
## First step is not a WHEN - 51
- C4103093 | Merit — edit period, roll-over time and start of week (Date Editor)
- C4103094 | Merit — configure a timeband (Timeband Editor)
- C4103095 | Merit — edit staff and operator details (Staff Editor)
- C4103096 | Merit — edit class types and class groups
- C4103097 | Merit — edit locations, location groups and location restrictions
- C4103098 | Merit — edit route groups (Route Group Editor)
- C4103099 | Merit — configure route revenue allocation (Route Revenue Editor)
- C4102960 | Sign On — valid credentials reach the CloudFare Dashboard
- C4102961 | Sign On — Google account sign-on (UNVERIFIED)
- C4102962 | Sign On — user can sign off CloudFare
- C4102965 | Settings — each Settings option opens its page
- C4102966 | Settings — Event Codes view/add/edit/import
- C4102967 | Settings — Operating Units add/edit/delete
- C4102968 | Settings — Scheduled Tasks enable/disable purges
- C4102969 | Settings — System Settings edit value / VAT / feature toggle
- C4102970 | Settings — edit a Notifications value
- C4102971 | Settings — edit External Interface Settings
- C4102972 | Settings — edit a Scheduled Adherence threshold
- C4102981 | Drawing Tool — add a new map point with a linked stop
- C4102982 | Drawing Tool — create, edit and delete a zone
- C4102983 | Drawing Tool — configure positional points on a route
- C4102984 | Drawing Tool — export map points to CSV and re-import edits
- C4102985 | Drawing Tool — search for a map point
- C4103011 | Topology — label prepared configuration data
- C4103012 | Topology — publish configuration with a future transition date
- C4103013 | Topology — re-publish an older configuration
- C4103014 | Topology — delete an active published topology label
- C4103044 | Staff Manager — add a staff member
- C4103045 | Staff Manager — modify a staff member's PIN
- C4103046 | Staff Manager — modify home and working location
- C4103047 | Staff Manager — view staff history
- C4103080 | Ticket Editor — create a ticket template
- C4103081 | Ticket Editor — add elements to a template
- C4103082 | Ticket Editor — copy a template and change its device type
- C4103083 | Ticket Editor — configure a change ticket (NOT IN SPEC)
- C4103084 | Product Editor — assign a ticket template to a product
- C4103085 | Ticket Editor — group a set of ticket layouts (NOT IN SPEC)
- C4103086 | Ticket Editor — add a barcode to a template
- C4103087 | Ticket Editor — add payment-card fields to a template
- C4102856 | Sign On — valid credentials reach the ABT Operator Portal
- C4102857 | Access — portal tasks match the operator's assigned claims
- C4102858 | Sign On — operator can sign off the ABT Operator Portal
- C4102878 | Admin — set End of Operational Day and Week
- C4102879 | Admin — set the maximum late data period
- C4102880 | Admin — set the maximum journey duration
- C4102881 | Admin — set debt-recovery retry attempts and message
- C4102882 | Admin — set a minimum fare for an e-Purse smartcard
- C4102927 | Passenger Portal — sign on to an anonymous account
- C4102928 | Passenger Portal — sign-on prevented for invalid, no-journey or blocked cards
- C4102929 | Passenger Portal — home screen shows balance and summary
- C4102930 | Passenger Portal — customer can sign off

## Step content not WHEN/AND - 71
- C4103093 | Merit — edit period, roll-over time and start of week (Date Editor)
- C4103094 | Merit — configure a timeband (Timeband Editor)
- C4103095 | Merit — edit staff and operator details (Staff Editor)
- C4103096 | Merit — edit class types and class groups
...
## A WHEN with no THEN outcome - 71
- C4103093 | Merit — edit period, roll-over time and start of week (Date Editor)
- C4103094 | Merit — configure a timeband (Timeband Editor)
- C4103095 | Merit — edit staff and operator details (Staff Editor)
- C4103096 | Merit — edit class types and class groups
...
- C4102818 | [UNCONFIRMED] Duplicate Detection — interleaved retail transactions do not reset the duplicate reference - the 09:05 tap is not charged again and is flagged a duplicate of the 0
- C4102818 | [UNCONFIRMED] Duplicate Detection — interleaved retail transactions do not reset the duplicate reference - the 09:10 tap is not charged and is flagged a duplicate of the same 09
- C4102819 | [UNCONFIRMED] Duplicate Detection — a same-stage repeat tap after a different-stage retail is still a duplicate - the 09:06 same-stage tap is not charged and is flagged a duplicate of 
