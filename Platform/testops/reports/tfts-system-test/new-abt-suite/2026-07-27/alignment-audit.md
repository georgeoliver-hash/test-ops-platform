...
- Advisory (reviewed-intentional) findings: **236**

## Residual mojibake in any field - 0
_none_

## Title missing the ' - ' feature separator _(advisory)_ - 61
...
- C4104935 | Annulling a tap reverses a Same Location duplicate marking where applicable
...
## Title over 72 chars _(advisory)_ - 175
...
- C4104935 | Annulling a tap reverses a Same Location duplicate marking where applicable - 75 chars
...
- C4102852 | Debt Recovery — automated Visa recovery clears a debt at a different amount - 75 chars
...
- C4104540 | Debt Recovery — automated Mastercard recovery clears a debt at a different amount - 81 chars
- C4104541 | Debt Recovery — automated Maestro recovery clears a recoverable issuer-liability debt - 85 chars
- C4102857 | Access — portal tasks match the operator's assigned Account Management claims - 77 chars
...
- C4104889 | Customer Services — operator retries a customer's declined payment (Visa) - 73 chars
- C4104890 | Customer Services — operator retries a customer's declined payment (Mastercard) - 79 chars
- C4102871 | Transfers — a qualifying Directional feeder-to-Glider transfer is charged £0.00 (Scenario 1) - 92 chars
- C4102875 | Capping config — a new rule's created date-time is correct (not an hour ahead) - 78 chars
- C4104545 | Transfers — a qualifying Non-Directional feeder-to-Glider transfer is charged £0.00 (Scenario 3) - 96 chars
- C4104546 | Transfers — a qualifying Glider-to-feeder transfer is charged £0.00 (Scenarios 2/4) - 83 chars
- C4104547 | Transfers — a qualifying Ulsterbus-to-Glider transfer is charged £0.00 (Scenario 11) - 84 chars
...
- C4102937 | Card Verification — declined Visa payments are guaranteed up to the Issuer Liability Threshold - 94 chars
- C4102938 | Card Verification — first use of a Visa card triggers an Account Verification Request - 85 chars
- C4102939 | Card Verification — first daily use of a Mastercard card triggers a pre-authorisation - 85 chars
- C4102940 | Card Verification — first use after Deny List removal of a Mastercard card triggers a pre-authorisation - 103 chars
- C4104552 | Card Verification — declined Mastercard payments are guaranteed up to the Issuer Liability Threshold - 100 chars
- C4104553 | Card Verification — declined Maestro payments are guaranteed up to the Issuer Liability Threshold - 97 chars
- C4104554 | Card Verification — first daily use of a Maestro card triggers a pre-authorisation - 82 chars
- C4104555 | Card Verification — first use after Deny List removal of a Maestro card triggers a pre-authorisation - 100 chars
...
- C4102954 | Declined taps — an expired card (DeclinedReason 1) is recorded on the Declined Taps Report - 90 chars
- C4104556 | Declined taps — a Deny-listed card (DeclinedReason 2) is recorded on the Declined Taps Report - 93 chars
- C4104557 | Declined taps — an ODA/authenticity failure (DeclinedReason 3) is recorded on the Declined Taps Report - 102 chars
- C4104558 | Declined taps — a cancelled tap (DeclinedReason 4) is recorded on the Declined Taps Report - 90 chars
- C4104559 | Declined taps — a BIN-listed card (DeclinedReason 15) is recorded on the Declined Taps Report - 93 chars
- C4104560 | Declined taps — a passback (Negative List) (DeclinedReason 20) is recorded on the Declined Taps Report - 102 chars
...
## Objective not starting 'This test is to confirm' - 40
...
- C4102894 | EMV Summary Report — Visa - **UNCONFIRMED** — not named in the seven governing ABT/BOS reporting s
...
- C4102908 | Retail Debt Report — Visa - **UNCONFIRMED** — not named in the seven governing ABT/BOS reporting s
...
- C4104548 | EMV Summary Report — MasterCard - **UNCONFIRMED** — not named in the seven governing ABT/BOS reporting s
- C4104549 | EMV Summary Report — Maestro - **UNCONFIRMED** — not named in the seven governing ABT/BOS reporting s
- C4104550 | Retail Debt Report — Mastercard - **UNCONFIRMED** — not named in the seven governing ABT/BOS reporting s
- C4104551 | Retail Debt Report — Maestro - **UNCONFIRMED** — not named in the seven governing ABT/BOS reporting s
