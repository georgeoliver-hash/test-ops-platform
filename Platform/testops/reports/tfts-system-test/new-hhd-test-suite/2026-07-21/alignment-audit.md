...
- C4103881 | Top-Up — a Multi-Journey top-up exceeding the 45-journey maximum is prevented - 77 chars
...
## Objective not starting 'This test is to confirm' - 4
- C4103831 | Top-Up — a top-up on an expired card is rejected - **CONFLICT** — same expired Adult iLink at top-up as C4103883, opposit
- C4103835 | ABT Tap — a card-expired inspection maps DeclinedReason to 1 - **CONFLICT** — expired-card inspection modelled differently from C4103
- C4103883 | Top-Up — an expired smartcard is topped up and reactivated - **CONFLICT** — same expired Adult iLink at top-up as C4103831, opposit
- C4103982 | Revenue Inspection — an expired card is declined and emits event 5010 - **CONFLICT** — expired-card inspection modelled differently from C4103
