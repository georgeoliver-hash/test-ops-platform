...
_Generated 2026-06-22T10:01:23+00:00 by system-test-ops. Suite id 30253, project TFTS - System Test._

**51 fully automatable + 125 partial** of 505 cases (5 destructive, 329 manual-only). _Partial = the UI flow is automatable but a step (card tap / print / cash) needs a hardware fixture or human eye._
...
### C4102563 · Faulty — Fare-Paying Smartcard  (12m)  — PARTIAL; cross-check: CloudFare / MERIT / SmartTrack
_Functional / Top Up & Validation / Faulty Card_

**GIVEN** a faulty fare-paying smartcard is presented on the POS
...
**WHEN** the operator selects the appropriate option and completes
...
### C4102564 · Faulty — Smartpass Receipt  (11m)  — PARTIAL; cross-check: CloudFare / MERIT / SmartTrack
_Functional / Top Up & Validation / Faulty Card_

**GIVEN** a faulty Smartpass (concessionary) is presented on the POS
...
### C4102565 · Faulty — Dependants Pass Receipt  (11m)  — PARTIAL; cross-check: CloudFare / MERIT / SmartTrack
_Functional / Top Up & Validation / Faulty Card_

**GIVEN** a faulty Dependants Pass is presented on the POS
...
### C4102561 · Fare-Paying Smartcard — top-up  (11m)  — PARTIAL; cross-check: CloudFare / MERIT / SmartTrack
_Functional / Top Up & Validation / Top Up_

**GIVEN** the POS is signed on and a fare-paying smartcard is presented
**WHEN** the operator tops up the card with value and takes payment
**THEN** the value is added to the card balance
**AND** the new balance is shown and a receipt is printed
**WHEN** the CloudFare activity log is checked
...
### C4102562 · Top Up — on expiry  (11m)  — PARTIAL; cross-check: CloudFare / MERIT / SmartTrack
_Functional / Top Up & Validation / Top Up_

**GIVEN** a smartcard is presented on its product expiry date
...
### C4102559 · Fare-Paying Smartcard — validation  (12m)  — PARTIAL; cross-check: CloudFare / MERIT / SmartTrack
_Functional / Top Up & Validation / Validation_

**GIVEN** the POS is signed on and a fare-paying smartcard with sufficient balance is presented
...
### C4102560 · Validation — passback  (12m)  — PARTIAL; cross-check: CloudFare / MERIT / SmartTrack
_Functional / Top Up & Validation / Validation_

**GIVEN** a smartcard has just been validated on the POS
**WHEN** the same smartcard is presented again within the passback period
**THEN** the passback rule is applied with no second deduction within the period
**WHEN** the smartcard is presented again after the passback period
