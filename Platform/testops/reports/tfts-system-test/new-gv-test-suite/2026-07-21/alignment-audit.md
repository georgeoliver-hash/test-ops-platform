...
- Cases audited: **96**
- Blocking findings: **0**
- Advisory (reviewed-intentional) findings: **39**
...
## Title over 72 chars _(advisory)_ - 39
...
- C4104038 | Barcode — a barcode validated on one gate head is rejected on another head of the same gateline - 95 chars
...
- C4104070 | Location Settings — location cannot be changed while comms to the back office is lost - 85 chars
...
- C4104100 | Heartbeat — the GV updates CloudFare Last Communication at least every 15 minutes - 81 chars
